...
func (_m *Repository) CreateLelangWithBid(lelang lelangs.Core, userID uint) error {
...
func (_m *Repository) DeleteLelang(id uint) error {
	ret := _m.Called(id)
...
func (_m *Repository) GetLelang(lelangid uint) (lelangs.Core, error) {
...
func (_m *Repository) GetLelangs() ([]lelangs.Core, error) {
	ret := _m.Called()
...
func (_m *Repository) GetLelangsByCategory(category string) ([]lelangs.Core, error) {
...
func (_m *Repository) GetLelangsByUserID(userid uint) ([]lelangs.Core, error) {
...
func (_m *Repository) UpdateLelang(id uint, updatedLelang lelangs.Core) error {
